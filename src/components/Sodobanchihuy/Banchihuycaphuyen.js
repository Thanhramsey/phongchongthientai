...
const Banchihuycaphuyen = React.memo(function Banchihuycaphuyen(props) {
              ...
              <div className={classes.col_md_6}>
                <div className={classes.item_center}>
                  <a className={classes.img} onClick={gotonhiemvusnn}>
                    <h2 className={classes.title_h4_tv}>Huyện Tuy Phước</h2>
                    <h2 className={classes.title_h4_tv}>
                      Ban chỉ đạo Huyện Tuy Phước
                    </h2>
                  </a>
                </div>
              </div>
              ...
              <div className={classes.col_md_6}>
                <div className={classes.item_center}>
                  <a className={classes.img} onClick={gotonhiemvuca}>
                    <h2 className={classes.title_h4_tv}>Thị xã An Nhơn</h2>
                    <h2 className={classes.title_h4_tv}>
                      Ban chỉ đạo Thị xã An Nhơn
                    </h2>
                  </a>
                </div>
              </div>
          ...
          <GridItem xs={12} sm={12} md={4}>
            <GridItem xs={12} sm={12} md={12}>
              <div className={classes.col_md_6}>
                <div className={classes.item_center}>
                  <a className={classes.img} onClick={gotonhiemvu}>
                    <h2 className={classes.title_h4_tv}>Huyện An Lão</h2>
                    <h2 className={classes.title_h4_tv}>
                      Ban chỉ đạo Huyện An Lão
                    </h2>
                  </a>
                </div>
              </div>
          ...
          <GridItem xs={12} sm={12} md={4}>
            <GridItem xs={12} sm={12} md={12}>
              <div className={classes.col_md_6}>
                <div className={classes.item_center}>
                  <a className={classes.img} onClick={gotonhiemvusnn}>
                    <h2 className={classes.title_h4_tv}>Thị xã Hoài Nhơn</h2>
                    <h2 className={classes.title_h4_tv}>
                      Ban chỉ đạo Thị xã Hoài Nhơn
                    </h2>
                  </a>
                </div>
              </div>
          ...
          <GridItem xs={12} sm={12} md={4}>
            <GridItem xs={12} sm={12} md={12}>
              <div className={classes.col_md_6}>
                <div className={classes.item_center}>
                  <a className={classes.img} onClick={gotonhiemvuca}>
                    <h2 className={classes.title_h4_tv}>Huyện Phù Cát</h2>
                    <h2 className={classes.title_h4_tv}>
                      Ban chỉ đạo Huyện Phù Cát
                    </h2>
                  </a>
                </div>
              </div>
...
Banchihuycaphuyen.propTypes = {
  test: PropTypes.string,
};
export default Banchihuycaphuyen;
