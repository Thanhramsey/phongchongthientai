...
import PivotTable from "components/Pivot/lib/pivot-tablesltt.js";
...
export default function ReactPivotsldb(props) {
  const {
    rows,
    dimensions,
    calculations,
    ...
    <div className="reactPivot">
      ...
      <div className="reactPivot-csvExport">
        <ReactHTMLTableToExcel
          ...
          table="table-to-xls"
          filename="SanLuongTrungTam"
          sheet="SanLuongTrungTam"
