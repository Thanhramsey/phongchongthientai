...
import PivotTable from "components/Pivot/lib/pivot-tablensld.js";
import ReactHTMLTableToExcel from "react-html-table-to-excel";
import "assets/css/Pivot.css";

export default function ReactPivotnsld(props) {
  const {
    rows,
    dimensions,
    calculations,
    ...
    <div className="reactPivot" style={{ height: "650px" }}>
      <div className="reactPivot-csvExport">
        <ReactHTMLTableToExcel
          ...
          table="table-to-xls"
          filename="NangSuatLaoDong"
          sheet="NangSuatLaoDong"
