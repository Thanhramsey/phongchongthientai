...
import PivotTable from "components/Pivot/lib/pivot-tablethdtdb.js";
import Dimensions from "components/Pivot/lib/dimensions.js";
import ReactHTMLTableToExcel from "react-html-table-to-excel";
import "assets/css/Pivot.css";

export default function ReactPivotthdtdb(props) {
  const {
    rows,
    dimensions,
    calculations,
    ...
    <div className="reactPivot">
      ...
      <div className="reactPivot-csvExport">
        <ReactHTMLTableToExcel
          ...
          table="table-to-xls"
          filename="DoanhThuDiaBan"
          sheet="DoanhThuDiaBan"
