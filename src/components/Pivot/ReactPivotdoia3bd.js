...
import PivotTable from "components/Pivot/lib/pivot-tabledoia3bd.js";
...
export default function ReactPivotdoia3bd(props) {
  const {
    rows,
    dimensions,
    calculations,
