...
const Dieudonglucluong = React.memo(function Dieudonglucluong(props) {
  const {
    lucluongrows,
    lucluongcolumns,
    quanhuyenrows,
  ...
  return (
    <GridContainer>
      <GridItem xs={12} sm={10} md={10}>
        ...
        <TextField id="outlined-basic" label="Số lượng" size="small" />
      </GridItem>
